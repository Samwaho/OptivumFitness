            ...
            <figure className="flex flex-col p-6 bg-gray md:p-12 rounded-lg box-shadow">
              <blockquote className="mx-auto mb-8 max-w-2xl ">
                ...
                <p className="my-4">
                  ...
                  but also my overall well-being. I can't thank Alex and the
                  team enough!"
                </p>
              </blockquote>
            ...
            <figure className="flex flex-col p-8 bg-gray box-shadow rounded-lg md:p-12 ">
              <blockquote className="mx-auto mb-8">
                ...
                <p className="my-4">
                  ...
                  training has redefined my fitness journey. I feel stronger,
                  more confident, and ready to take on any challenge. Thank you,
                  Mark!"
                </p>
              </blockquote>
              <figcaption className="flex items-center space-x-3">
            ...
            <figure className="flex flex-col p-8 bg-gray rounded-lg box-shadow md:p-12">
              <blockquote className="mx-auto mb-8 max-w-2xl ">
                ...
                <p className="my-4">
                  ...
                  has not only improved my flexibility but also brought a sense
                  of calm I never knew I needed."
                </p>
              </blockquote>
              <figcaption className="flex items-center space-x-3">
                <img
