            ...
            <div className="items-center bg-gray rounded-lg box-shadow sm:flex">
              ...
              <div className="p-5">
                ...
                <p className="mt-3 mb-4 font-light ">
                  ...
                  stretch not only your muscles but also your sense of inner
                  peace and balance.
                </p>
                <ul className="flex space-x-4 sm:mt-0">
                  <li>
          ...
          <Reveal>
            <div className="items-center bg-gray rounded-lg box-shadow sm:flex ">
              ...
              <div className="p-5">
                ...
                <p className="mt-3 mb-4 font-light">
                  Michael is the maestro of personalized fitness. Crafting
                  unique plans, he ensures your fitness journey aligns
                  seamlessly with your goals and lifestyle.
                </p>
                <ul className="flex space-x-4 sm:mt-0">
                  <li>
                    <a href="#" className="color-text">
